...
urlpatterns = [
    ...
    path('api/docs/swagger/', SpectacularSwaggerView.as_view(url_name="api-schema"), name='swagger-ui'),  # Explicit Swagger UI path
    ...
    path('api/bankoperations/', include('bankAccountOperations.urls')),
